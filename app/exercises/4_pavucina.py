...
def page():
    ...
    a = col1.number_input("$a$", value=24)
    b = col2.number_input("$b$", value=3)
    c = col3.number_input("$c$", value=1)
    d = col4.number_input("$d$", value=2)
    p_0 = st.number_input("$P_0$", value=3)
